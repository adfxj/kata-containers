...
#[derive(Clone)]
pub struct MetaVirtioDevice {
    pub virtio_device: Arc<Mutex<dyn virtio_devices::VirtioDevice>>,
...
pub struct DeviceManager {
    ...
    pub virtio_devices: Vec<MetaVirtioDevice>,
...
impl DeviceManager {
    ...
    fn make_virtio_fs_device(
        ...
        if let Some(bfs_cfg) = &fs_cfg.clone().backendfs_config {
