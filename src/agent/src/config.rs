...
const KATA_VISIBLE_DEVICES_OPTION: &str = "agent.kata_visible_devices";
...
pub struct AgentConfig {
    ...
    // When enabled, the agent translates a container's KATA_VISIBLE_DEVICES
    // environment variable into CDI device requests (nvidia.com/gpu) so that
    // the container sees the matching GPUs present in the VM.
    pub kata_visible_devices: bool,
...
pub struct AgentConfigBuilder {
    ...
    pub kata_visible_devices: Option<bool>,
...
impl FromStr for AgentConfig {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        config_override!(agent_config_builder, agent_config, kata_visible_devices);
...
impl AgentConfig {
    ...
    pub fn from_cmdline(file: &str, args: Vec<String>) -> Result<AgentConfig> {
        ...
        for param in params.iter() {
            ...
            parse_cmdline_param!(
                param,
                KATA_VISIBLE_DEVICES_OPTION,
                config.kata_visible_devices,
                get_bool_value
            );
